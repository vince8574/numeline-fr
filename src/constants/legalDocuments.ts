...
Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation de l'application mobile **numelineFR**.

## 2. Description du service

numelineFR est une application mobile permettant de :
...
numelineFR ne saurait être tenu responsable :
...
L'application numelineFR, son design, son logo et tous les éléments qui la composent sont protégés par le droit d'auteur et la propriété intellectuelle.
